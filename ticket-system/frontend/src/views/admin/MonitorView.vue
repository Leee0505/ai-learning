  ...
  <div class="monitor-page">
    <header class="page-header">
      ...
      <div class="page-header-right">
        ...
        <button class="pause-btn" @click="togglePause" :aria-label="paused ? 'Resume' : 'Pause'">
          {{ paused ? '▶' : '⏸' }}
        </button>
...
.pause-btn { width: 44px; height: 44px; display: flex; align-items: center; justify-content: center; font-size: 18px; background: var(--color-white); border: 1px solid var(--color-gray-200); border-radius: var(--radius-md); cursor: pointer; }
